<template>
  <div class="flex justify-start my-2">
    ...
    <nuxt-img class="rounded-md md:w-[150px] w-[90px]" :src="product.url" loading="lazy" />
    ...
    <div class="overflow-hidden pl-2 w-full">
      ...
      <p class="text-[#0009A66] text-xs font-semibold pt-1">Free 11-day delivery over £8.28</p>

      <p class="text-[#0009A66] text-xs font-semibold pt-1">Free Shipping</p>
